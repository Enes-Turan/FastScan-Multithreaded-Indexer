...
public class CrawlerApp {
    public static void main(String[] args) {
        ...
        System.out.print("Aranacak Dosya İsmi veya Uzantısı: ");
        ...
        crawler.scanDirectory(new File(path), searchKey);
        ...
        if (results.size() > 0) {
            ...
            System.out.println("Eşleşen dosya bulunamadı. Klasör yolunu veya arama anahtarını kontrol et.");
        }
    }
}